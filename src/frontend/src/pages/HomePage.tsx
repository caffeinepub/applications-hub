    ...
    >
      ...
      >
        ...
        <div
          style={{
            ...
            height: "8px",
            backgroundImage:
              "repeating-conic-gradient(oklch(0.4 0.12 245) 0% 25%, oklch(0.15 0.05 245) 0% 50%)",
        ...
        <div
          style={{
            ...
            inset: 0,
            background:
              "repeating-linear-gradient(-45deg, transparent, transparent 20px, oklch(0.55 0.26 245 / 0.03) 20px, oklch(0.55 0.26 245 / 0.03) 21px)",
            pointerEvents: "none",
          }}
        />
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
            ...
            <div
              style={{
                ...
                boxShadow:
                  "0 0 12px oklch(0.82 0.18 85 / 0.8), inset 0 0 8px oklch(0.82 0.18 85 / 0.2)",
            ...
            <span
              ...
              style={{
                ...
                textShadow:
                  "0 0 10px oklch(0.55 0.26 245 / 0.8), 2px 2px 0 oklch(0.05 0.01 265)",
                letterSpacing: "2px",
                lineHeight: 1,
              }}
            >
      ...
      <main className="flex-1 page-enter">
        ...
        <section
          style={{
            background:
              "linear-gradient(180deg, oklch(0.09 0.02 265) 0%, oklch(0.12 0.04 265) 50%, oklch(0.09 0.02 265) 100%)",
            padding: "40px 16px",
            position: "relative",
            overflow: "hidden",
          }}
        >
          ...
          <div
            style={{
              ...
              inset: 0,
              backgroundImage:
                "radial-gradient(oklch(0.82 0.18 85 / 0.6) 1px, transparent 1px)",
          ...
          <div
            style={{
              ...
              inset: 0,
              background:
                "repeating-linear-gradient(-15deg, transparent, transparent 30px, oklch(0.55 0.26 245 / 0.04) 30px, oklch(0.55 0.26 245 / 0.04) 31px)",
              pointerEvents: "none",
            }}
          />
          ...
          <div className="relative max-w-2xl mx-auto text-center">
            ...
            <h1
              ...
              style={{
                ...
                color: "oklch(0.97 0.01 265)",
                textShadow:
                  "0 0 20px oklch(0.55 0.26 245 / 0.8), 0 0 40px oklch(0.55 0.26 245 / 0.4), 3px 3px 0 oklch(0.05 0.01 265)",
                letterSpacing: "3px",
              }}
            >
              APPLICATIONS HUB
            ...
            >
              <span>━━━━━</span>
              <span style={{ color: "oklch(0.62 0.22 245)" }}>
                ZONE 1 ACT 1
              </span>
              <span>━━━━━</span>
            </div>
        ...
        >
          <div
            className="checkerboard-bg-animated"
            style={{
              position: "absolute",
              top: 0,
              left: 0,
      ...
      >
        ...
        >
          © 2026. Built with{" "}
          <span style={{ color: "oklch(0.6 0.23 27)" }}>♥</span> using{" "}
          <a
