      ...
      >
        ...
        <span
          ...
          style={{
            ...
            textShadow: "0 0 8px oklch(0.65 0.18 195 / 0.6)",
          }}
        >
          FACE SCAN
        </span>
            ...
            >
              ...
              <div
                style={{
                  ...
                  inset: 0,
                  background:
                    "repeating-linear-gradient(0deg, oklch(0.55 0.26 245 / 0.15) 0px, transparent 2px, transparent 20px)",
              ...
              >
                <div
                  style={{
                    ...
                    width: "16px",
                    height: "16px",
                    borderTop: "3px solid oklch(0.82 0.18 85)",
                    borderLeft: "3px solid oklch(0.82 0.18 85)",
                  }}
                />
                <div
                  style={{
                    ...
                    height: "16px",
                    borderTop: "3px solid oklch(0.82 0.18 85)",
                    borderRight: "3px solid oklch(0.82 0.18 85)",
                  }}
                />
                <div
                  style={{
                    ...
                    width: "16px",
                    height: "16px",
                    borderBottom: "3px solid oklch(0.82 0.18 85)",
                    borderLeft: "3px solid oklch(0.82 0.18 85)",
                  }}
                />
                <div
