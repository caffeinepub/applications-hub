...
export const ParentalControlsPage: React.FC<ParentalControlsPageProps> = ({
  ...
  const initialFilter =
    currentUser?.parentalControls?.contentFilterEnabled ?? true;
  const initialRating = (currentUser?.parentalControls?.maxAgeRating ??
    BigInt(1)) as bigint;
          ...
          >
            ...
            <button
              ...
              style={{
                ...
                position: "relative",
                transition: "all 0.2s",
                boxShadow: contentFilter
                  ? "0 0 12px oklch(0.65 0.18 130 / 0.4)"
                  : "none",
                flexShrink: 0,
              }}
              aria-label={
            ...
            {ratings.map((rating) => (
              <button
                ...
                style={{
                  ...
                  boxShadow:
                    maxRating === rating
                      ? `0 0 12px ${ratingColors[rating]} / 0.3`
                      : "none",
                }}
              >
                <span
